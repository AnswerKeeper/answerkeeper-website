      ...
      <div className="relative mx-auto max-w-6xl px-5 pb-8 pt-16 sm:px-8 sm:pt-24 lg:pt-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="animate-fade-up-delay-3 mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            >
              AnswerKeeper in Action
              <ArrowRight size={16} />
            </a>
            <a
              href="#how-it-works"
              className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-border-strong bg-white px-8 text-sm font-semibold text-navy transition hover:border-blue-mid hover:bg-blue-soft/40 sm:w-auto"
            >
              <Play size={15} className="fill-navy" />
              Watch 90-Second Demo
            </a>

            <div className="mt-6 flex flex-wrap justify-center gap-4 text-sm text-navy-muted">
